...
public class ChartJsView implements Serializable {
    ...
    public void createBarModel() {
        ...
        barDataSet.setLabel("Delivery Men Statistics By Delivery Number");
        List<DeliveryMan> devMen = deliveryManServices.retrieveAlleDliveryMen();
        List<Number> values = new ArrayList<>();
        for (DeliveryMan deliveryMen: devMen){
         values.add(deliveryMen.getNbDelivery());
        }
        ...
        labels.add(deliveryMen.getFirstName());
        }
       data.setLabels(labels);
