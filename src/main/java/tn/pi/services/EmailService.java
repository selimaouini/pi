...
public class EmailService {
    ...
    public void sendMailMultipart2(String toEmail, String subject, String message, File file) throws MessagingException {
