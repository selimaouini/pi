...
import tn.esprit.spring.entities.Rayon.Type_rayon;
...
private String nom_rayon;
	...
	public String updaterayon() {
		String navigateTo = "/addrayon.xhtml";
		Rayon r=rayonDAO.updateRayon(new Rayon(nom_rayon,type_rayon));
